...
console.log('🍽️  Creating The Lost Cow activity with minimal schema...\n');

const lostCowId = 'f9b0d6e1-4c5e-4f3a-0d8e-2b3c4d5e6f7a';

// Create the activity with minimal fields
...
if (verifyImages && verifyImages.length === 3) {
  console.log('\n✅ SUCCESS! The Lost Cow created with 3 unique images');
} else {
  console.log('\n❌ FAILED! The Lost Cow does not have 3 images');
  process.exit(1);
}
