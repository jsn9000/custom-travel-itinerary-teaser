...
import { Lock, Star, Plane, Building2, Check, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(to bottom right, #faf9f7, #f5f3ef, #fdfcfa)' }}>
      ...
      <div className="absolute top-4 left-4 z-50">
        <Link href="/" className="inline-flex items-center px-4 py-2 bg-white/90 hover:bg-white text-gray-800 rounded-full font-semibold text-sm shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5">
